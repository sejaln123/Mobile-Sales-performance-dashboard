...
* **Mobile Model Sales:** Bar chart comparing model-level performance
* **Daily Sales Trend:** Line/area chart showing sales across days of the week
* **Payment Method Distribution:** Pie chart showing usage of UPI, Debit Card, Cash, and Credit Card
